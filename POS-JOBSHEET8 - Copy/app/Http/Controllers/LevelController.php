    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($levels)
            ...
            ->addColumn('aksi', function ($levels) {
                // return '<a href="' . url('/level/' . $levels->level_id) . '" class="btn btn-info btn-sm">Detail</a> ' .
                //     '<a href="' . url('/level/' . $levels->level_id . '/edit') . '" class="btn btn-warning btn-sm">Edit</a> ' .
                //     '<form class="d-inline-block" method="POST" action="' . url('/level/' . $levels->level_id) . '">' .
