                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="user_id" id="user_id" class="form-control" disabled>
                            <option value="{{ $user->user_id }}" selected>{{ $user->nama }}
                                ({{ $user->level->level_nama }})</option>
                        </select>
                        <small id="error-user-id" class="error-text form-text text-danger"></small>
                    ...
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input value="{{ $stok->stok_tanggal_masuk }}" type="datetime-local" name="stok_tanggal_masuk" id="stok_tanggal_masuk"
