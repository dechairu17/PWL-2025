    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('/stok/export_excel') }}" class="btn btn-sm btn-primary"><i class="fa fa-file-excel"></i> Export Stok Excel</a>
                <a href="{{ url('/stok/export_pdf') }}" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf"></i> Export Stok PDF</a>
                <button onclick="modalAction('{{ url('stok/create_ajax') }}')" class="btn btn-sm btn-success">Tambah Data</button>
            </div>
        </div>
        <div class="card-body">
            <!-- Filter untuk data user -->
        ...
        $(document).ready(function() {
            dataStok = $('#table_stok').DataTable({
                ...
                columns: [
                    ...
                    { data: "stok_tanggal_masuk", className: "", orderable: true, searchable: true },
...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('/stok/beli/'.$stok->stok_id) }}" method="POST">
                @csrf
